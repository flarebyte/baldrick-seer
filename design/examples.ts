...
export type PairwiseStrength = 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9;
...
export const exampleScenarioBasedMcda: McdaModel = {
  ...
  alternatives: [
    ...
    },
    {
      ...
      name: "Platform C",
      description:
        "Enterprise-oriented option with strong reliability and compliance",
    },
  ],
  ...
  scenarios: [
    {
      ...
      name: "Startup",
      description:
        "Small company with budget pressure and need for rapid experimentation",
      narrative:
      ...
      preferences: {
        ...
        comparisons: [
          ...
          },
          {
            ...
            strength: 2,
            justification:
              "Scalability matters, but near-term survival matters more.",
            source: "hybrid",
            confidence: "medium",
          },
          {
            ...
            strength: 2,
            justification:
              "A slightly faster launch is preferred over marginal savings.",
            source: "hybrid",
            confidence: "medium",
          },
          {
            ...
            strength: 2,
            justification:
              "Growth readiness slightly outweighs mature reliability.",
            source: "hybrid",
            confidence: "medium",
          },
          {
            ...
            strength: 2,
            justification:
              "Immediate execution is slightly more important than future growth capacity.",
            source: "hybrid",
            confidence: "medium",
          },
        ],
      ...
      evaluations: [
        {
          ...
          values: {
            ...
            scalability: { kind: "number", value: 70, source: "ai" },
            reliability: { kind: "number", value: 68, source: "ai" },
          },
        },
        {
          ...
          values: {
            ...
            scalability: { kind: "number", value: 88, source: "ai" },
            reliability: { kind: "number", value: 80, source: "ai" },
          },
        },
        {
          ...
          values: {
            ...
            scalability: { kind: "number", value: 82, source: "ai" },
            reliability: { kind: "number", value: 92, source: "ai" },
          },
        },
      ],
    },
      ...
      preferences: {
        ...
        comparisons: [
          ...
          },
          {
            ...
            strength: 3,
            justification:
              "Scalability is moderately more important than reliability during hyper-growth.",
            source: "hybrid",
            confidence: "medium",
          },
          {
            ...
            strength: 2,
            justification:
              "Service continuity is slightly more important than savings.",
            source: "hybrid",
            confidence: "medium",
          },
          {
            ...
            strength: 3,
            justification:
              "Compliance matters, but scale pressure is stronger in this phase.",
            source: "hybrid",
            confidence: "medium",
          },
          {
            ...
            strength: 2,
            justification:
              "Reliability slightly outweighs compliance during rapid expansion.",
            source: "hybrid",
            confidence: "medium",
          },
          {
            ...
            strength: 2,
            justification:
              "As the company grows, governance matters more than pure cost.",
            source: "hybrid",
            confidence: "medium",
          },
        ],
      ...
      evaluations: [
        {
          ...
          values: {
            ...
            scalability: { kind: "number", value: 72, source: "ai" },
            reliability: { kind: "number", value: 70, source: "ai" },
            compliance: { kind: "number", value: 58, source: "ai" },
          },
        },
        {
          alternativeId: "platform_b",
          values: {
            ...
            scalability: { kind: "number", value: 93, source: "ai" },
            reliability: { kind: "number", value: 84, source: "ai" },
            compliance: { kind: "number", value: 76, source: "ai" },
          },
        },
        {
          alternativeId: "platform_c",
          values: {
            ...
            scalability: { kind: "number", value: 87, source: "ai" },
            reliability: { kind: "number", value: 94, source: "ai" },
            compliance: { kind: "number", value: 91, source: "ai" },
          },
        },
      ],
    },

    {
      ...
      description:
        "Mature organization with governance, reliability, and compliance needs",
      narrative:
        ...
        comparisons: [
          {
            ...
            strength: 5,
            justification:
              "Operational stability strongly outweighs cost in mature environments.",
            source: "hybrid",
            confidence: "high",
          },
          {
          ...
          },
          {
            ...
            strength: 3,
            justification:
              "Reliability is moderately more important than future scaling potential.",
            source: "hybrid",
            confidence: "medium",
          },
          {
            ...
            strength: 3,
            justification:
              "Governance is moderately more important than scaling capacity.",
            source: "hybrid",
            confidence: "medium",
          },
          {
            ...
            strength: 2,
            justification:
              "Reliability is slightly more important than compliance.",
            source: "hybrid",
            confidence: "medium",
          },
          {
            ...
            strength: 2,
            justification:
              "Future flexibility is still slightly more important than raw cost savings.",
            source: "hybrid",
            confidence: "medium",
          },
        ],
      ...
      constraints: [
        {
          ...
          value: 70,
          justification:
            "Enterprise scenario requires minimum compliance readiness.",
        },
      ],
      evaluations: [
        {
          ...
          values: {
            ...
            reliability: { kind: "number", value: 69, source: "ai" },
            compliance: { kind: "number", value: 60, source: "ai" },
            scalability: { kind: "number", value: 72, source: "ai" },
          },
        },
        {
          ...
          values: {
            ...
            reliability: { kind: "number", value: 86, source: "ai" },
            compliance: { kind: "number", value: 80, source: "ai" },
            scalability: { kind: "number", value: 90, source: "ai" },
          },
        },
        {
          alternativeId: "platform_c",
          values: {
            ...
            reliability: { kind: "number", value: 96, source: "ai" },
            compliance: { kind: "number", value: 95, source: "ai" },
            scalability: { kind: "number", value: 85, source: "ai" },
          },
        },
      ],
    },
  ...
  scenarios: [
    {
      id: "lean_startup",
      name: "Lean Startup",
      activeCriteria: [{ criterionId: "cost" }, { criterionId: "speed" }],
      preferences: {
        method: "ahp_pairwise",
        scale: "saaty_1_9",
        comparisons: [
...
export const exampleScenarioBasedMcdaJson = JSON.stringify(
  exampleScenarioBasedMcda,
  null,
  2,
);
